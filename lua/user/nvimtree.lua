...
vim.cmd(string.format("highlight NvimTreeFolderName guifg=%s gui=bold", colors.green))
vim.cmd(string.format("highlight NvimTreeRootFolder guifg=%s gui=bold", colors.yellow))
vim.cmd(string.format("highlight NvimTreeEmptyFolderName guifg=%s gui=bold", colors.green))
vim.cmd(string.format("highlight NvimTreeOpenedFolderName guifg=%s gui=bold", colors.green))
...
vim.cmd(string.format("highlight NvimTreeFolderIcon guifg=%s gui=bold", colors.green))
